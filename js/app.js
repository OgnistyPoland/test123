...
<br>
<footer class="text-muted"> <div class="container"> <p class="float-right"> <a href="#">Powrót do góry</a> </p> ${UI.credit ? '<p>Redesigned with <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-heart-fill" fill="red" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" /> </svg> by <a href="https://github.com/OgnistyPoland/test123" target="_blank">Ognisty321</a>, based on Open Source Softwares.</p>' : ''} <p>© ${UI.copyright_year} - <a href=" ${UI.company_link}" target="_blank"> ${UI.company_name}</a>, All Rights Reserved.</p> </div> </footer>
  `;
	$('body').html(html);
}
...
function nav(path) {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Bieżąca ścieżka</a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item"  href="/${cur}:/ ">> Home</a>`;
...
<p class="card-text text-center"><a href="${href}" class="btn btn-primary">Pobierz</a></p><br>
<script src="https://cdn.jsdelivr.net/gh/OgnistyPoland/test123/js/ace/1.4.7/ace.js"></script>
<script src="https://cdn.jsdelivr.net/gh/OgnistyPoland/test123/js/ace/1.4.7/ext-language_tools.js"></script>`;
	$('#content').html(content);
