/**
* A Script Redesigned by Ognisty321 from GOIndex at https://github.com/OgnistyPoland/test123
*/
const authConfig = {
	"siteName": "Szisza", // Website name
	"client_id": "81164457688-g0m77ja67lqbdvs9qknri6uhqusomhv3.apps.googleusercontent.com",
	"client_secret": "Vc2qJTd8uFHCoxSi0sbyL-_a",
	"refresh_token": "1//0cxC9d6hr-GAUCgYIARAAGAwSNwF-L9IrF3crqV1D5kHb3HFG7_pp85-614WWMnJ-7xV9QtBD_pR4uSVe6LK5m-CTuASzujYNjtk", // Authorize token
	/**
	...
	"roots": [
    {
		"id": "1gZlXfkPclZwm6cJUawcME9uzJEQ6HuPq",
		"name": "Muxy",
		"user": "",
		"pass": "",
    ...
    {
		"id": "1_otTkJcIQRtIC1O6cJXDU3him2Ok0EaI",
		"name": "Hardsuby",
		"user": "",
		"pass": "",
		"protect_file_link": false
 ...
 */
const uiConfig = {
	"theme": "bootstrap", // Change doesn't works
	"dark_mode": true, // switch between light or dark themes
	"version": "2.0.8", // don't touch this one. get latest code using generator at https://github.com/OgnistyPoland/test123
	"logo_image": true, // true if you're using image link in next option.
	"logo_height": "", // only if logo_image is true
	"logo_width": "60px", // only if logo_image is true
	"logo_link_name": "https://i.imgur.com/VpqM4PD.gif", // if logo is true then link otherwise just text for name
	"contact_link": "https://discordapp.com/invite/V625Q7R", // Link to Contact Button on Menu
	"copyright_year": "2020-2021", // year of copyright, can be anything like 2015 - 2020 or just 2020
	"company_name": "Shisha", // Name next to copyright
	"company_link": "https://discordapp.com/invite/V625Q7R", // link of copyright name
	...
	"jsdelivr_cdn_src": "https://cdn.jsdelivr.net/gh/OgnistyPoland/test123"
};
